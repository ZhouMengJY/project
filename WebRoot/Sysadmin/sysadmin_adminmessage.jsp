...
<c:choose>
    ...
    <table border="1" >
	  ...
	  <c:forEach var="admin" items="${listc}">
	  <tr>
	    <td align="center" >${admin.adminID}</td>
	    <td align="center" >${admin.dormID}</td>
	    <td align="center" >${admin.password}</td>
	    <td align="center" >${admin.name}</td>
	    <td align="center" >${admin.sex}</td>
	    <td align="center" >${admin.phone}</td>
	    <td align="center" >${admin.remarks}</td>
	    <td align="center">
		    <form action="/dormitory/Sysadmin/sysadmin_modifyadmin.jsp?admin.adminID=${admin.adminID}&admin.dormID=${admin.dormID}
		    &admin.password=${admin.password}
		    &admin.name=${admin.name}&admin.sex=${admin.sex}
		    &admin.phone=${admin.phone}&admin.remarks=${admin.remarks}" method="post">
			
                <input type ='submit'  value='修改' >
		 	</form>	
		 </td>
		 <td align="center">
		 	<form action="/dormitory/Sysadmin_deleteadmin?admin.adminID=${admin.adminID}" method="post">
