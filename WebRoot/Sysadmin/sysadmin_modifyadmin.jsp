...
<% 
	...
	String dormID=request.getParameter("admin.dormID");
	...
	String remarks=request.getParameter("admin.remarks");
	  	
  	%>
  	
  	<form action="/dormitory/Sysadmin_modifyadmin" method="post">
      	<table border="1" width="80%" align="center">
    		<tr>
    			<td>宿舍管理员编号</td>
    			<td>
    				<input readonly="readonly" type="text" name="adminID" value="<%=adminID%>">
    			</td>
    			<td>楼栋号</td>
    			<td>
