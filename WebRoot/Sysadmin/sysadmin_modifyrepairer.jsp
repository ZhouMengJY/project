...
<div>   	
  <% 
	...
	String password=request.getParameter("repairer.password");
	String name=request.getParameter("repairer.name");
	String sex=request.getParameter("repairer.sex");
	String phone=request.getParameter("repairer.phone");
	String remarks=request.getParameter("repairer.remarks");
	  	
  	%>
  	
  	<form action="/dormitory/Sysadmin_modifyrepairer" method="post">
      	<table border="1" width="80%" align="center">
    		<tr>
    			<td>维修人员编号</td>
    			<td>
    				<input readonly="readonly" type="text" name="repairerID" value="<%=repairerID%>">
    			</td>
    			<td>密码</td>
    			<td>
    		...
    		<tr>
    			...
    			<td>备注</td>
    			<td>
    				<input type="text" name="password" value="<%=remarks%>">
    			</td>
    		</tr>   		
    		<tr>
      	  		<td>
