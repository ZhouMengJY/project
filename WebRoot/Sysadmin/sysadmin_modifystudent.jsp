...
<div>   	
  <% 
    request.setCharacterEncoding("utf-8");
  	...
  	String stuID=request.getParameter("student.stuID");
	...
	String dormID=request.getParameter("student.dormID");
	String roomID=request.getParameter("student.roomID");
	String xueyuan=request.getParameter("student.xueyuan");
	String major=request.getParameter("student.major");
	String classes=request.getParameter("student.classes");
	String phone=request.getParameter("student.phone");
	String birthday=request.getParameter("student.birthday");
	String remarks=request.getParameter("student.remarks");
  	
  	%>
  	
  	<form action="/dormitory/Sysadmin_modifystudent" method="post">
      	<table border="1" width="80%" align="center">
    		<tr>
    			<td>学号：</td>
    			<td>
    				<input readonly="readonly" type="text" name="stuID" value="<%=stuID%>">
    			</td>
    			<td>姓名：</td>
    			<td>
    		...
    		<tr>
    			<td>楼栋号：</td>
    			<td>
    				<input type="text" name="dormID" value="<%=dormID%>">
    			</td>
    			<td>房间号：</td>
    			<td>
    		...
    		<tr>
    			<td>所属学院：</td>
    			<td>
    				<input type="text" name="xueyuan" value="<%=xueyuan%>">
    			</td>
    			<td>专业：</td>
    			<td>
