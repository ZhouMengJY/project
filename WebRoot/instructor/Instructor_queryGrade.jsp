...
<div>   	
<div>
   <form action="/dormitory/Instructor_queryGrade" method="post">
   	<table align="center">
   		<tr>
   			<td>
   				楼栋号：
...
<c:choose>
    ...
    <table border="1" >
	  ...
	  <c:forEach var="grade" items="${list5}">
	  <tr>
	        <td align="center" align="center">${grade.dateID}</td>
		    <td align="center" align="center">${grade.time}</td>
		    <td align="center" align="center">${grade.dormID}</td>
		    <td align="center" align="center">${grade.roomID}</td>
		    <td align="center" align="center">${grade.points}</td>
		    <td align="center" align="center">${grade.score}</td> 
		    <td align="center" align="center">${grade.remarks}</td> 		        	    
	  </tr>
	  </c:forEach>
	</table>
	</center>
