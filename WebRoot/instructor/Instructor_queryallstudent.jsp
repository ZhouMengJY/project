...
<div>   	
<form action="/dormitory/Instructor_queryallstudent" method="post">
    <div align="center">
    	<table align="center">
    		<tr>
    			<td>
    ...
    <table border="1" >
	  ...
	  <c:forEach var="student" items="${list21}">
	  <tr>
	        <td align="center" align="center">${student.stuID}</td>
		    <td align="center" align="center">${student.name}</td>
		    <td align="center" align="center">${student.sex}</td>
		    <td align="center" align="center">${student.dormID}</td>
		    <td align="center" align="center">${student.roomID}</td> 
		    <td align="center" align="center">${student.major}</td> 
		    <td align="center" align="center">${student.classes}</td> 
		    <td align="center" align="center">${student.phone}</td> 
		    <td align="center" align="center">${student.birthday}</td> 
		    <td align="center" align="center">${student.remarks}</td> 		        	    
	  </tr>
	  </c:forEach>
	</table>
	</center>
