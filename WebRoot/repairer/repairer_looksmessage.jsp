...
<div>   	
 <c:choose>
    ...
    <table border="1" >
	  ...
	  <c:forEach var="repair" items="${list13}">
	  <tr>
	        <td align="center">${repair.repairID}</td>
		    <td align="center">${repair.name}</td>
		    <td align="center">${repair.phone}</td>
		    <td align="center">${repair.times}</td>
		    <td align="center">${repair.dormID}</td>
		    <td align="center">${repair.roomID}</td> 
		    <td align="center">${repair.GZmiaoshu}</td>
		    <td align="center">${repair.remarks}</td>   	
		   	<td align="center">
		   		<form action="/dormitory/Repairer_dealGZ?repair.repairID=${repair.repairID}" method="post">
