...
<div>   	
	  ...
	  <tr>
    	...
    	<th width="100">寝室得分</th>    	
      </tr>
       <c:forEach var="grade" items="${list}">
	  <tr>
	  	<td align="center" valign="center">${grade.dateID}</td>
	  	<td align="center" valign="center">${grade.time}</td>
	  	<td align="center" valign="center">${grade.dormID}</td>
	  	<td align="center" valign="center">${grade.roomID}</td>
	  	<td align="center" valign="center">${grade.points}</td>
	  	<td align="center" valign="center">${grade.score}</td>
	  </tr>
	  </c:forEach>
	  </table>
</div>
